...
export class ContactsService {
    ...
    _contacts: BehaviorSubject<Contact[] | null> = new BehaviorSubject(null);
    ...
    getContacts(): Observable<Contact[]> {
        return this._httpClient.get<Contact[]>(`${this.baseUrl}GetAllUser?PageNumber=${this.pageNumber}`).pipe(
            tap((contacts) => {
